...
const getGradientOffsets = (
  ...
  const percentageWhereZScorePlusOne =
    ((zScorePlusOne - minValue) / range) * 100
  const percentageWhereZScoreMinusOne =
    ((zScoreMinusOne - minValue) / range) * 100

  return {
    start: Math.min(
      percentageWhereZScoreMinusOne,
      percentageWhereZScorePlusOne
    ),
